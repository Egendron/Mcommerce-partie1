...
public class ProductController {
    ...
    public MappingJacksonValue listeProduits() {
        ...
        MappingJacksonValue produitsFiltres = getMappingJacksonValue(produits);
   ...
   public ResponseEntity<Void> ajouterProduit(@Valid @RequestBody Product product) {
        if (product.getPrix() == 0)
            throw new ProduitGratuitException("un produit avec un prix de vente valant 0 ne peut être ajouté");
    ...
    //transforme l'objet renvoyé par la DAO pour ne pas renvoyer le prix d'achat en sortie de service
    private MappingJacksonValue getMappingJacksonValue(Iterable<Product> produits) {
